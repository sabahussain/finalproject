...
<div class="container-wrapper">
    <div class="container">
        ...
        <button class="btn btn-default" name="_eventId_backtocartview">Back</button>

        <input type="submit" value="Next" class="btn btn-default" name="_eventId_forwardtoorderconfirmation" />
